<template>
  <div class="playground">
    <section class="split-section">
      <h2>Chars Split</h2>
      <p ref="charsEl" class="split-text">Anime.js text split example for characters.</p>
      <button @click="animateChars">Animate Chars</button>
    </section>
    <section class="split-section">
      <h2>Words Split</h2>
      <p ref="wordsEl" class="split-text">Another text split example using words to animate.</p>
      <button @click="animateWords">Animate Words</button>
    </section>
    <section class="split-section">
      <h2>Lines Split</h2>
      <p ref="linesEl" class="split-text">Finally we split lines to animate line by line with Anime.js.</p>
      <button @click="animateLines">Animate Lines</button>
    </section>
  </div>
</template>
...
const animateWords = () => {
  ...
  if (splitter) {
    $anime.animate(splitter.words, { y: [-20, 0], opacity: [0, 1], delay: $anime.stagger(40) })
  }
}
